...
# -*- coding: utf-8 -*-
#
# meteo_si documentation build configuration file, created by
...
project = 'meteo_si'
copyright = '2018, Maximilian Maahn'
...
latex_documents = [
  ('index', 'meteo_si.tex', 'meteo_si Documentation',
   'Maximilian Maahn', 'manual'),
]
