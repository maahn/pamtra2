...
def NDto2DtoND(referenceIn=0,noOfInDimsToKeep=1, convertInputs=[0],convertOutputs=[0],verbosity=0):
  ...
  def NDto2DtoND_decorator(func):
    ...
    def inner(*args, **kwargs):
      if verbosity>0: print ('decorating %s'%func.__name__, referenceIn, noOfInDimsToKeep, convertInputs, convertOutputs)
      referenceShape = None
      addDims = False
      args = list(args)
      ...
      for ii in [referenceIn] + convertInputsHere:
        ...
        if addDims or (referenceIteration and (len(inShape) == noOfInDimsToKeep)):
        ...
        # we remove dimensions
          ...
          #be more careful to remove not too many dimensions
            ...
            noOfInDimsToKeepHere = len(inShape) - len(referenceShape)
          ...
          inShapeFlatten = inShape[:len(inShape)-noOfInDimsToKeepHere]
        ...
        if verbosity > 0: print('in',ii,inShape,inShapeNew,referenceShape,addDims)
