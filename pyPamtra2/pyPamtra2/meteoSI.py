...
Md = 0.028964 #kg/mol molar mass of dry air
Mv = 0.018016 #kg/mol molar mass of water vapor
Mwml = Mv/Md #0.622 # dimlos, Molmassenverhaeltnis
...
def hypsometric_equation(p1,p2,Tv):
    """
    Tv: vitual temperature in K 
    p1: pressure level1
    p2: pressure level2
    
    returns thicknes in m

    source: AMS glossary hypsometric equation

    """    

    delta_z = Rair * Tv/Grav * np.log(p1/p2)
    return delta_z
