...
@decorators.NDto2DtoND(referenceIn=0,noOfInDimsToKeep=0,convertInputs=[0,1,2],convertOutputs=[0],verbosity=10)
def calcSpectralBraodening(
  ...
  wavelength = constants.speedOfLight / (frequency*1e9)  
...
@decorators.NDto2DtoND(referenceIn=0,noOfInDimsToKeep=2,convertInputs=list(range(11)),convertOutputs=[0],verbosity=1)
