...
module dia2vel
  ...
  !to be deleted after transition to pamtra v1.0
      ...
      character(len=36) :: nameOfRoutine = 'dia2vel_heymsfield10_particles_ms_as'  
...
!       k = 0.5d0 !defined in the paper
  ...
  subroutine dia2vel_khvorostyanov01_particles &
    ...
    velSpec)        !out
      ...
      real(kind=dbl), dimension(ndia):: X, bRe, aRe
...
!       velSpec = Av * diaSpec**Bv !2.23
  ...
  subroutine dia2vel_khvorostyanov01_spheres &
    ...
    velSpec)        ! out
      ...
      integer(kind=long) :: err = 0
      character(len=80) :: msg
      character(len=31) :: nameOfRoutine = 'dia2vel_khvorostyanov01_spheres'
  ...
  subroutine dia2vel_rogers_drops &
    ...
    velSpec)        ! out
      ...
      integer(kind=long) :: err = 0
      character(len=80) :: msg
      character(len=20) :: nameOfRoutine = 'dia2vel_rogers_drops'
  ...
  subroutine dia2vel_rogers_graupel &
    ...
    velSpec)        ! out
      ...
      integer(kind=long) :: err = 0
      character(len=80) :: msg
      character(len=22) :: nameOfRoutine = 'dia2vel_rogers_graupel'
  ...
  subroutine dia2vel_corrected_power_law &
    ...
    velSpec)            ! out
      ...
      integer(kind=long) :: err = 0
      character(len=80) :: msg
      character(len=27) :: nameOfRoutine = 'dia2vel_corrected_power_law'
